...
@section('title' , 'Indias Leading App Development Agency | 10+ Years Industry Experience')
@section('description' , 'We are a leading mobile app development company that builds custom apps to
streamline business services. Our skilled developers can turn your ideas into reality with native
iOS and Android apps or cross-platform apps.')
@section('content')

<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    <main id="main">
        <!-- Hero Section - design Page -->
        <section class="p-5 text-center bg-image app-development-hero-bg">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">

                        <h1 data-animation="slideInUp" data-animation-delay=".6s" class="text-md-start text-center">App
                            Development
                        </h1>
                ...
                <div class="row about_comp pb-lg-5 pb-md-4 pb-3">
                    ...
                    <div class=" col-lg-6 col-md-6 col-sm-12 m-auto pe-lg-5 d-flex align-items-center justify-content-center"
                        ...
                        <div class="pt-5">
                            <ul class="text-white list-unstyled service__list__icon">
                                <p class="text-white" style="text-align:justify;">Empower your business with
                                    cutting-edge mobile apps tailored to your
                                    needs. From concept to deployment, our expert team delivers:</p>
                                <ul class="text-white list-unstyled service__list__icon">
                                    <li class="">
                                        <p><strong>Custom App Design:</strong> Unique interfaces that resonate with your
                                            audience.</p>
                                    </li>
                                    <li class="">
                                        <p><strong>Cross-Platform Development:</strong> Reach users across iOS and
                                            Android seamlessly.</p>
                                    </li>
                                    <li class="">
                                        <p><strong>User-Centric Experience:</strong> Intuitive designs for enhanced
                                            usability.</p>
                                    </li>
                                    <li class="">
                                        <p><strong>Scalable Solutions:</strong> Future-proof apps that grow with your
                                            business.</p>
                                    </li>
                                    <li class="">
                                        <p><strong>Security & Compliance:</strong> Robust measures to protect your
                                            users' data.</p>
                                    </li>
                                </ul>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12  aboutus_img">
                        <div class="about_img_1">
                            <img src="{{ asset('assets/img/services/app-development.png')}}" class="img-fluid"
                        ...
                        <div class="row d-flex align-items-center justify-content-center" data-animation="slideInRight"
                            ...
                            <div class="col-lg-11">
                                <form action="{{ route('store.contact') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <h3 class="text-md-start  text-center   pb-3">LET'S DISCUSS YOUR PROJECT</h3>
                                    <div class="row">
