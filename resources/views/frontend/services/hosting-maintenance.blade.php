...
@section('title' , 'Website Maintenance and Hosting Services in India | Give Your Business a New Look')
@section('description' , 'We ensure that your site is always up-to-date and running smoothly with cost-
effective solutions delivered within your time constraints. Webwide handles the websites
technical requirements, providing speed enhancement, security, backups, and unlimited
support.')
@section('content')
...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    <main id="main">
        ...
        <section class="p-5 text-center bg-image hosting-maintenance-hero-bg">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="text-white d-flex align-items-center justify-content-md-start justify-content-center"
                            ...
                            <nav aria-label="breadcrumb ps ">
                                <ol class="breadcrumb banner_breadcrumb mb-0 justify-content-md-start justify-content-center">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Hosting &
                                        Maintenance</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container py-lg-5 py-md-4 py-3">
                <div class="row" data-animation="slideInDown" data-animation-delay=".3s">
                    <div class="text-center col-lg-12">
                        <h4 class="sub_title red_color" style="color: #1fb104">Services we provide for hosting and
                            maintenance
                        </h4>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-6">
                                <ul class="list-unstyled">
                                    <li class="services-list-icon">Maximized uptime</li>
                                    <li class="services-list-icon">Free malware removal</li>
                                    <li class="services-list-icon">Ultra secure hosting</li>
                                    <li class="services-list-icon">Lightning fast page load times</li>
                                    <li class="services-list-icon">WordPress specialized hosting</li>
                                    <li class="services-list-icon">Hosting support</li>

                                </ul>
                            </div>
                            <div class="col-md-7 col-sm-6">
                                <ul class="list-unstyled">
                                    <li class="services-list-icon">Better performance through even workload distribution
                                    </li>
                                    <li class="services-list-icon">Increased stability with traffic increases </li>
                                    <li class="services-list-icon">Decreased costs </li>
                                    <li class="services-list-icon">Faster loading websites through site caching </li>
                                    <li class="services-list-icon">Keeps your data secure and safe </li>
                                    <li class="services-list-icon">Automatic updates </li>
                                </ul>
                            </div>
                        </div>
                    </div>
