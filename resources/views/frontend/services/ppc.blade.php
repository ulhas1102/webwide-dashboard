...
@section('title' , 'Pay Per Click (PPC) and Paid Media Marketing in India | Digital Marketing Agency')
@section('description' , 'Are you tired of your low-performing PPC ads? Schedule a Strategy call with ads
Experts. Scale your Business with paid traffic, without any complexity. 87% Ads Success Ratio.
PPC Ads Expert')
@section('content')
...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    <main id="main">
        ...
        <section
            class="p-5 text-center bg-image service-hero-bg d-flex align-items-center justify-content-center  justify-content-md-start ">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h1 data-animation="slideInUp" data-animation-delay=".6s" class="text-md-start text-center">PPC
                        </h1>
            ...
            <div class="container py-lg-5 py-md-4 py-3">
                <div class="row" data-animation="slideInDown" data-animation-delay=".3s">
                    <div class="text-center col-lg-12">
                        <h4 class="sub_title red_color" style="color: #1fb104">Services we provide for ppc </h4>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6">
                                <ul class="list-unstyled">
                                    <li class="services-list-icon">Search Ads</li>
                                    <li class="services-list-icon">Display Ads</li>
                                    <li class="services-list-icon">Social Ads</li>
                                </ul>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <ul class="list-unstyled">
                                    <li class="services-list-icon">Remarketing Ads</li>
                                    <li class="services-list-icon">Google Shopping Ads</li>
                                    <li class="services-list-icon">In-stream Ads</li>
                                    <li class="services-list-icon">Local Services Ads</li>
                                </ul>
                            </div>
                        </div>
                    </div>
