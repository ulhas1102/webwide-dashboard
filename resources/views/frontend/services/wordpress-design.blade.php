...
@section('title' , 'WordPress Website Design Agency | WordPress Web Design Experts')
@section('description' , 'Webwide is a WordPress website design agency that creates quality-driven digital
experiences and site optimization for search. Your success is our mission. Our skilled
WordPress professionals with 9+ Years Of Experience In Delivering WordPress Designs.')
@section('content')

<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    <main id="main">
        <!-- Hero Section - design Page -->
        <section class="p-5 text-center wordpress-bg-image service-hero-bg">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="text-white d-flex align-items-center justify-content-md-start justify-content-center"
                            ...
                            <nav aria-label="breadcrumb ps ">
                                <ol
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Wordpress Design</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container py-lg-5 py-md-4 py-3">
                <div class="row about_comp pb-lg-5 pb-md-4 pb-3">
                    ...
                    <div class=" col-lg-6 col-md-6 col-sm-12 m-auto pe-lg-5 d-flex align-items-center justify-content-center"
                        ...
                        <div class="pt-5">
                            <p class="text-white" style="text-align:justify;">Unlock the full potential of your website
                                with our comprehensive WordPress development services. Whether you're starting from
                                scratch or need enhancements to your existing site, our expert developers are here to
                                help.</p>

                            <ul class="text-white list-unstyled service__list__icon">
                                <p class=" text-white mb-1"><strong>Custom Theme Development:</strong></p>
                                <li class="">
                                    <p> Tailored designs to reflect your
                                        brand's unique identity. </p>
                                </li>
                                <li>
                                    <p> Responsive layouts for seamless user experience on all
                                        devices.</p>
                                </li>
                                <p class=" text-white mb-1"><strong>Plugin Development:</strong></p>
                                <li class="">
                                    <p> Custom plugins to add specific
                                        functionalities.
                                    </p>
                                </li>
                                <li>
                                    <p class="">Optimization of existing plugins for better performance.</p>
                                </li>
                                <p class=" text-white mb-1"><strong>E-commerce Solutions:</strong></p>
                                <li class="">
                                    <p> WooCommerce integration for robust online
                                        stores.</p>
                                </li>
                                <li>
                                    <p class="">Secure payment gateways and intuitive product management.</p>
                                </li>
                            </ul>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12  aboutus_img">
                        <div class="about_img_1">
                            <img src="{{ asset('assets/img/services/wordpress-design.png')}}" class="img-fluid"
