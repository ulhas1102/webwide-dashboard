...
@section('title' , 'Social Media Marketing Agency | Best Digital Marketing Agency')
@section('description' , 'Looking for a Social Media Marketing service? Webwide is the best Social media
marketing company in India. Our social media agency can help increase your brands visibility.
We offer strategy, branding, creative content, social media management and advertising
services.')
@section('content')
...
<body class="index-page" data-bs-spy="scroll" data-bs-target="#navmenu">
    <main id="main">
        ...
        <section class="p-5 text-center bg-image social-media-marketing-hero-bg">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="text-white d-flex align-items-center justify-content-md-start justify-content-center"
                            ...
                            <nav aria-label="breadcrumb ps ">
                                <ol
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Social Media
                                        Marketing</li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container py-lg-5 py-md-4 py-3">
                <div class="row" data-animation="slideInDown" data-animation-delay=".3s">
                    <div class="text-center col-lg-12">
                        <h4 class="sub_title red_color" style="color: #1fb104">Services we provide for Social Media
                            Marketing
                        </h4>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <ul class="list-unstyled">
                                    <li class="services-list-icon">Social Media Marketing</li>
                                    <li class="services-list-icon">Social Media Management</li>
                                    <li class="services-list-icon">Social Media Brand Management</li>

                                </ul>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <ul class="list-unstyled">
                                    <li class="services-list-icon">Social Media Follower Growth</li>
                                    <li class="services-list-icon">Social Media SEO</li>
                                    <li class="services-list-icon">Drive More Clicks and Views</li>
                                    <li class="services-list-icon">Attract Qualified Leads</li>
                                </ul>
                            </div>
                        </div>
                    </div>
