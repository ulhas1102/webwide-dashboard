          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a class="text-white" href="{{route('add-home-page-title-description')}}">Add Home Page SEO</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center">
                      <a href="{{ route('edit-home-page-seo', ['id' => $seo->seo_id]) }}" class="btn text-primary"><i class="fas fa-edit fa-fw"></i></a>
...
<script>
  function handleDeleteDriver(id) {
        ...
        Swal.fire({
            title: 'Delete Home Page SEO',
            html: `
                <div class="row" style="text-align:center !important;justify-content: center;">
                    <p class="text-danger" style="font-size:18px;">Are You Sure you want to delete home page SEO?</p>
                </div>
                <div class="d-none">
                    <p></p>
                    <form id="deleteDriver" action="{{route('home-page-seo-delete')}}" method="post">
                    @csrf
