...
@section('title', 'Privacy Policy SEO edit')
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="posteditprivacypolicypageseo" method="post">
                        	@csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter Privacy Policy Page Title" value="{{$seo->title}}" required>
                                    @error('tile')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="exampleInputEmail1" placeholder="Enter Privacy Policy Page description" required>{{$seo->description}}</textarea>
                                    @error('description')
			                          <div class="alert alert-danger">{{ $message }}</div>
			                        @enderror
                                </div>
