...
@section('title', 'Privacy Policy Page SEO')
...
@endif
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Privacy Policy Page SEO</h1>
          </div>
           <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item text-white"><a class="text-white" href="/">Home</a></li>
                        <li class="breadcrumb-item active"><a class="text-white" href="{{route('add-privacy-policy-page-title-description')}}">Add Privacy Policy  Page SEO</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center">
                      <a href="{{ route('edit-privacy-policy-page-seo', ['id' => $seo->seo_id]) }}" class="btn text-primary"><i class="fas fa-edit fa-fw"></i></a>
  ...
  function handleDeleteDriver(id) {
        ...
        Swal.fire({
            ...
            html: `
                ...
                <div class="d-none">
                    <p></p>
                    <form id="deleteDriver" action="{{route('privacy-policy-page-seo-delete')}}" method="post">
                    @csrf
