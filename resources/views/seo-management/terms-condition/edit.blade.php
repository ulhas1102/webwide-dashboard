...
@section('title', 'Terms Condition SEO edit')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Quick Edit <small>Terms Condition page SEO</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="posteditTermsConditionpageseo" method="post">
                        	@csrf
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter Terms Condition Page Title" value="{{$seo->title}}" required>
                                    @error('tile')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" id="exampleInputEmail1" placeholder="Enter Terms Condition Page description" required>{{$seo->description}}</textarea>
                                    @error('description')
			                          <div class="alert alert-danger">{{ $message }}</div>
			                        @enderror
                                </div>
