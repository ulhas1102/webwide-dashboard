...
@section('title', 'Terms Condition Page SEO')
...
@endif
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Terms Condition Page SEO</h1>
          </div>
           <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item text-white"><a class="text-white" href="/">Home</a></li>
                        <li class="breadcrumb-item active"><a class="text-white" href="{{route('add-terms-condition-page-title-description')}}">Add Terms Condition  Page SEO</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center">
                      <a href="{{ route('edit-terms-condition-page-seo', ['id' => $seo->seo_id]) }}" class="btn text-primary"><i class="fas fa-edit fa-fw"></i></a>
...
<script>
  function handleDeleteDriver(id) {
        ...
        Swal.fire({
            title: 'Delete Privacy Policy Page SEO',
            html: `
                <div class="row" style="text-align:center !important;justify-content: center;">
                    <p class="text-danger" style="font-size:18px;">Are You Sure you want to delete privacy Policy page SEO?</p>
                </div>
                <div class="d-none">
                    <p></p>
                    <form id="deleteDriver" action="{{route('terms-condition-page-seo-delete')}}" method="post">
                    @csrf
