...
@section('title', 'About Us Page SEO')
...
@endif
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>About Us Page SEO</h1>
          </div>
           <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item text-white"><a class="text-white" href="/">Home</a></li>
                        <li class="breadcrumb-item active"><a class="text-white" href="{{route('add-about-us-page-title-description')}}">Add About Us Page SEO</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-content-center">
                      <a href="{{ route('edit-about-us-page-seo', ['id' => $seo->seo_id]) }}" class="btn text-primary"><i class="fas fa-edit fa-fw"></i></a>
...
<script>
  function handleDeleteDriver(id) {
        ...
        Swal.fire({
            title: 'Delete About Us Page SEO',
            html: `
                <div class="row" style="text-align:center !important;justify-content: center;">
                    <p class="text-danger" style="font-size:18px;">Are You Sure you want to delete about us page SEO?</p>
                </div>
                <div class="d-none">
                    <p></p>
                    <form id="deleteDriver" action="{{route('about-us-page-seo-delete')}}" method="post">
                    @csrf
