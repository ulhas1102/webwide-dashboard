          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a class="text-white" href="add-blog">Career List</a></li>
                    </ol>
                </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$data->phone}}</td>
                    <td>{{$data->position}}</td>
                 	<td><a href="{{ asset('backend/resume-pdf/'.$data->resume ) }}" download>{{$data->resume}}</a></td>
					 <td class="d-flex justify-content-center">
                    	
                    	 <a href="javascript:void(0);" onclick="handleDeleteCareer({{ $data->id }});" class="btn text-red"> <i class="fas fa-trash fa-fw"></i></a>	
                    </td>
...
<script>
	function handleDeleteCareer(id) {
        ...
        Swal.fire({
            ...
            html: `
                <div class="row" style="text-align:center !important;justify-content: center;">
                    <p class="text-danger" style="font-size:18px;">Are You Sure you want to delete career?</p>
                </div>
                <div class="d-none">
                    <p></p>
                    <form id="deleteCareer" action="{{route('career-delete')}}" method="post">
                    @csrf
            ...
            preConfirm: () => {
                ...
                document.getElementById('deleteCareer').submit();
            },
        });
    }
</script>
